...
static ngx_command_t  ngx_stream_upstream_check_commands[] = {
    ...
    { ngx_string("check_status"),
      NGX_STREAM_SRV_CONF|NGX_CONF_TAKE1|NGX_CONF_NOARGS,
...
static ngx_http_module_t  ngx_stream_upstream_check_module_ctx = {
...
ngx_stream_upstream_check_init_main_conf(ngx_conf_t *cf, void *conf)
{
    ...
    umcf = ngx_http_conf_get_module_main_conf(cf, ngx_stream_upstream_module);
