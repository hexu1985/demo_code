...
!(function ($) {
    ...
    */
    ...
    // 春节（2020-01-18 00:00:00 - 2020-02-01 00:00:00）
    // 博客之星（上线日期-2020-02-29 00:00:00）
    function isFestivalRange (day) {
      var start_time,
          end_time,
          now_time = Math.floor(Date.now() / 1000), // 当前时间戳
          ChineseNewYear_start_time = getTimestamp('2020-01-18 00:00:00'),
          ChineseNewYear_end_time = getTimestamp('2020-02-01 00:00:00'),
    ...
    // 设置节日背景图片
    function setFestiveImage () {
      $('#blogClick img').attr('src', 'https://csdnimg.cn/cdn/content-toolbar/csdn-write-festival.png');
      $('#remind img').attr('src', 'https://csdnimg.cn/cdn/content-toolbar/messageIcon-festival.png');
    }
