...
int main(int argc, char* argv[])
{
	...
	try {
		...
		cout << "waiting enter any key for send mesage 1" << endl;
		cin.get();
		...
		cout << "waiting enter any key for send mesage 2" << endl;
		cin.get();
		...
		cout << "waiting enter any key for send mesage 3" << endl;
		cin.get();
		...
		cout << "waiting enter any key for send mesage 4" << endl;
		cin.get();
