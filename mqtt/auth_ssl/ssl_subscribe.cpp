...
const std::string DFLT_SERVER_ADDRESS	{ "ssl://10.4.98.74:8883" };
const std::string DFLT_CLIENT_ID		{ "ssl_subscribe_cpp" };

const std::string KEY_STORE				{ "/home/hexu/TLSDir/client/client.pem" };
const std::string TRUST_STORE			{ "/home/hexu/TLSDir/ca/ca.crt" };
...
public:
	callback(mqtt::async_client& cli, mqtt::connect_options& connOpts, const std::string &client_id)
				: nretry_(0), cli_(cli), connOpts_(connOpts), subListener_("Subscription"), CLIENT_ID(client_id) {}
};
...
//	mqtt::connect_options connOpts;
	...
	callback cb(client, connOpts, clientID);
