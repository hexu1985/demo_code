...
# shared lib: 
# libmylib.so -> liblib1_s.a, libmynew_s.a
# main.o -> libmylib.so
...
g++ -o libmylib.so -shared -L. -Wl,--whole-archive liblib1_s.a -Wl,--no-whole-archive libmynew_s.a -Wl,--exclude-libs,libmynew_s.a
